...
class Function7DataHandler(BaseDataHandler):
    ...
    def add_weekly_updates(self):
        ...
        self.append_week_point(11, [1.004605, 0.095923, 1.042067, 0.699317, 0.031596, 1.108582], 0.16253706042540253)
        self.append_week_point(12, [0.985191, 1.089133, 1.131315, 0.346786, 0.457217, 1.196637], 0.001138200184952793)
        self.append_week_point(13, [0.034394, 1.148551, 1.177488, 0.052325, 0.642873, 0.107275], 0.010664864856794742)
